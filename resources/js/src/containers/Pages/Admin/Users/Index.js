...
class Index extends Component {
    ...
    render() {
        let { backend: { users: { loading, error, totalUsers, total } } } = this.props;
        ...
        content = (
            <>
                <Row>
                    <List loading={loading} array={usersData} data={JSON.stringify(totalUsers)} get={this.props.onGetAdminUsers} total={total} dark bordered icon={faThList} title="User List" add="Add User" link="/admin/users/add" innerClassName="bg-darkblue" className="bg-darklight shadow-sm"
                        fields={[
...
const mapDispatchToProps = dispatch => ({
    onGetAdminUsers: (page, show, search) => dispatch(actions.getAdminUsers(page, show, search)),
