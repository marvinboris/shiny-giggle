...
import { faEye, faUsers, faUserTie, faTimesCircle, faCheckCircle, faPrint, faEdit, faTrash, faSpinner, faBell, faShoppingCart, faMoneyBillWaveAlt, faPaperPlane, faTimes, faCheck } from '@fortawesome/free-solid-svg-icons';
        ...
        if (loading) content = <Col xs={12}>
            ...
            if (notifications) {
                const notificationsData = notifications.map(notification => {
                    ...
                    return <ListGroupItem color="darklight" className="border-darkblue-20">
