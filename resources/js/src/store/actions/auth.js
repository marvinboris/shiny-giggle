...
export const authLogin = data => async dispatch => {
    ...
    try {
        ...
        const res = await fetch('http://invest-calc.test:3000/api/user/login', {
            method: 'POST',
            mode: 'cors',
            body: form,
        });
...
export const authSignup = data => async dispatch => {
    ...
    try {
        ...
        const res = await fetch('http://invest-calc.test:3000/api/user/signup', {
            method: 'POST',
            mode: 'cors',
            body: form,
        });
...
export const authGuestSignup = data => async dispatch => {
    ...
    try {
        ...
        const res = await fetch('http://invest-calc.test:3000/api/guest/login', {
            method: 'POST',
            mode: 'cors',
            body: form,
        });
...
export const authCheckState = () => async dispatch => {
    ...
    if (!token) dispatch(authLogout());
        ...
        try {
            const res = await fetch('http://invest-calc.test:3000/api/guest/user', {
                method: 'GET',
                headers: {
                    'Authorization': token
                }
