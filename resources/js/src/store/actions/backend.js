...
export const getAutoReinvests = (page = 1, show = 10, search = '') => async dispatch => {
    ...
    try {
        const res = await fetch(`${rootPath}/api/user/options/auto-reinvest?page=${page}&show=${show}&search=${search}`, {
            method: 'GET',
            headers: {
                Authorization: token
            }
...
export const getAutoReinvestInit = () => async dispatch => {
    ...
    try {
        const res = await fetch(`${rootPath}/api/user/options/auto-reinvest/init`, {
            method: 'GET',
            headers: {
                Authorization: token
            }
...
export const getAutoReinvest = id => async dispatch => {
    ...
    try {
        const res = await fetch(`${rootPath}/api/user/options/auto-reinvest/${id}`, {
            method: 'GET',
            headers: {
                Authorization: token
            }
...
export const postAutoReinvest = data => async dispatch => {
    ...
    try {
        ...
        const res = await fetch(`${rootPath}/api/user/options/auto-reinvest`, {
            method: 'POST',
            mode: 'cors',
            body: formData,
            headers: {
