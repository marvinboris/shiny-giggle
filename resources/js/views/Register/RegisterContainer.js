...
class RegisterContainer extends Component {
    ...
    // 2.2
    // componentWillMount, componentDidMount etc etc that have 
    //componentStuffStuff are known as React Lifecycles which of course 
    //you already know 
    componentWillMount() {
                ...
                <div className="row">
                    <div className="offset-xl-3 col-xl-6 offset-lg-1 col-lg-10 col-md-12 col-sm-12 col-12 ">
                        ...
                        {this.state.error ? <FlashMessage duration={900000} persistOnHover={true}>
                            ...
                            </ul></FlashMessage> : ''}          <form onSubmit={this.handleSubmit}>
